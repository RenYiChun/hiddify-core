...
func addHConfigFlags(commandRun *cobra.Command) {
	...
	commandRun.Flags().StringVar(&defaultConfigs.Region, "region", "other", "region code used for direct DNS and routing rules")
	...
	commandRun.Flags().Uint16Var(&defaultConfigs.InboundOptions.MixedPort, "in-proxy-port", 12434, "Input Mixed Port")
